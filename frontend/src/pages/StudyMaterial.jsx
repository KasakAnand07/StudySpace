...
export default function SubjectStudyMaterial() {
  ...
  }, [id]); // <-- dependency added here

  useEffect(() => {
    if (!id) return;
    fetchMaterials();
  }, [id, fetchMaterials]); // <-- add fetchMaterials here
  ...
  return (
    <LayoutWrapper
      title={`📘 ${subjectName} — Study Materials`}
      subtitle={`Manage your study materials for ${subjectName}.`}
    >
